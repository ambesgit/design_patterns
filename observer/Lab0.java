...
{
	private ICounter decrement;
	private ICounter increment;
    private IState stateOfCount;
	public Lab0()
	{
		...
		stateOfCount=new State();
		decrement = new DecrementCounter(stateOfCount);
		increment=new IncrementCounter(stateOfCount);
