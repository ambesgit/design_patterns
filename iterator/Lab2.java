...
public class Lab2 extends javax.swing.JFrame
{
	...
	void JButtonAllSwimmers_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		while(itr.hasNext()){
			sw=(Swimmer)itr.next();
			 JTextArea1.append(sw.getFname()+" "+sw.getLname()+ " \n");
...
//		}
	...
	
	{
		...
		MyList<Swimmer> mylist=new MyList<Swimmer>();		
		mylist.addAll(slist.getVector());  
		Iterator itr=mylist.reversIterator();
		Swimmer sw;
		 while(itr.hasNext()){
			 sw=(Swimmer)itr.next();
			 JTextArea2.append(sw.getFname()+" "+sw.getLname()+ " \n");
		 };
...
//		}
	...
	void JButtonAllAbove12_actionPerformed(java.awt.event.ActionEvent event)
	{
		...
		mylist.addAll(slist.getVector());  
		Iterator itr=mylist.selectionIterator(12);
		Swimmer sw;
		 while(itr.hasNext()){
			 sw=(Swimmer)itr.next();	
			JTextArea3.append(sw.getFname()+" "+sw.getLname()+ " \n");
